...
# 
cloudinary.config(
    cloud_name=os.getenv("CLOUDINARY_CLOUD_NAME", "dtpyi3jfl"),
    api_key=os.getenv("CLOUDINARY_API_KEY", "535814964662664"),
    api_secret=os.getenv("CLOUDINARY_API_SECRET", "9cNSAp9zt9BE-yX-_P648BtLE6o")
)

CHANNEL_ACCESS_TOKEN = os.getenv("LINE_CHANNEL_ACCESS_TOKEN", "OGt0JcwolAAdUlmZUhE2FKEJKwqc3qXykVf8Zd5d+tZU806x6wulnH+koUF8Ij6qcDuj8of7mWVhxlCiSVOc+qV3cDLa1Z3p+dgFhOSrhuUdY+qD15V3vLQPnfQheoQXsHbpdi06h7sKQFm7Z7R5uwdB04t89/1O/w1cDnyilFU=")
